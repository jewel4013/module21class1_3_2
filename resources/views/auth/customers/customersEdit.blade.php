...
@section('PageHeader', 'Customer Edit')
        ...
        <div class="row g-3" style="font-size: 13px;">
            ...
            <div class="col-12 col-md-4">   
                ...
                <input type="text" id="name" 
                    class="form-control form-control-sm border-light-subtle rounded-2" 
            ...
            <div class="col-12 col-md-4">
                ...
                <input type="text" id="phone" class="form-control form-control-sm border-light-subtle rounded-2" 
            ...
            <div class="col-12 col-md-4">
                ...
                <input type="email" id="email" class="form-control form-control-sm border-light-subtle rounded-2" 
            ...
            <div class="col-12 col-md-4">
                ...
                <input type="text" id="address" class="form-control form-control-sm border-light-subtle rounded-2" 
            ...
            <div class="col-12 col-md-4">
                ...
                <input type="text" id="thana" class="form-control form-control-sm border-light-subtle rounded-2" 
            ...
            <div class="col-12 col-md-4">
                ...
                <input type="text" id="district" class="form-control form-control-sm border-light-subtle rounded-2" 
